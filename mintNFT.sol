...
contract Mint721Token is ERC721URIStorage, ERC2981 {
    ...
    //IERC20 public token_wETH = IERC20(0x7a79603fC330157e1f447602520C1e1F74F770a3); // test wETH CA
    //IERC20 public token_UNI = IERC20(0x64f784E9Ff6268F1478aA2c666F951D61A909912); // test UNI CA
    //IERC20 public token_LINK = IERC20(0xBa14CbF8B0d0B5F05092A71633945540326a64F2); // test LINK CA
    ...
    function mintNFTCover_wETH(uint8 _coverTerm, uint8 _coverRatio, uint _amount, string memory _ipfsHash) public {
        ...
        uint currentTokenPrice = token1 / token2; // wETH 가격 = USDT 예치량 / WETH 예치량 | 1 wETH = 1879 USDT
    ...
    function mintNFTCover_UNI(uint8 _coverTerm, uint8 _coverRatio, uint _amount, string memory _ipfsHash) public {
        ...
        uint currentTokenPrice = token1 / token2; // UNI 가격 = USDT 예치량 / UNI 예치량 | 1 UNI = 5.263 USDT
    ...
    function mintNFTCover_LINK(uint8 _coverTerm, uint8 _coverRatio, uint _amount, string memory _ipfsHash) public {
        ...
        uint currentTokenPrice = token1 / token2; // LINK 가격 = USDT 예치량 / LINK 예치량 | 1 LINK = 6.172 USDT
