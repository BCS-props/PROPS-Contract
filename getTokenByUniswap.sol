...
/*
    ---------------------------------------------------------------------------------------
    유니스왑 풀에 예치된 토큰 갯수를 가져오는 컨트랙트 

    uniswap V3 dev reference : https://docs.uniswap.org/contracts/v3/reference/deployments

    uniswap V3 factory CA : 0x1F98431c8aD98523631AE4a59f267346ea31F984
    create Pool CA : 0x6E47d80aA74D5c65d5CeA5d6013ecf4EAD152d51
    getpool CA : 0xA2E2e1a8891C9c85403a8632366ae73E228f60B0
    ...
    goerli LINK : 0xBa14CbF8B0d0B5F05092A71633945540326a64F2
        ...
        goerli USDT/LINK pool CA : 0x84647B99Ca1ee4128013b08f6f3e6E87fda7B260
            ...
            // 유니스왑 풀에 예치된 토큰의 갯수를 불러오기 위해 직접 만든 컨트랙트
            0xad89ea694eD2C5EB8Ecb197Bb633b673AdFC0AaC getbalance (USDT/UNI)
            0xA75deC799397430a0F9Ea1E3b9B2e5046Ef64584 getbalance (USDT/wETH)
            0x18a93F0bbD067279cBcb880f3E81dD925f6FD54a getbalance (USDT/LINK)
    ---------------------------------------------------------------------------------------
*/
